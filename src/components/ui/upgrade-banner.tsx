    ...
    <div className={cn("mx-auto flex items-center justify-center", className)}>
      <AnimatePresence>
        ...
        >
          ...
          <div className="relative flex h-[35px] items-center gap-1 rounded-[6px] border border-inkaer-light-blue bg-blue-50 pl-2.5 pr-1 text-sm">
            <button
              className="focus-visible:shadow-focus-ring rounded-xs my-[-1px] cursor-pointer border-none bg-transparent px-0 py-1 font-sora text-[13px] font-medium text-inkaer-dark-blue underline decoration-inkaer-light-blue underline-offset-[5px] outline-none hover:text-inkaer-blue hover:decoration-inkaer-blue focus-visible:!shadow-inkaer-blue"
            ...
            <span className="text-[0.8125rem] text-inkaer-blue font-sora">
              {description}
            </span>
            {onClose && (
              <button 
                onClick={onClose}
                className="m-0 flex h-6 !w-6 shrink-0 cursor-pointer items-center justify-center rounded-[4px] border-0 bg-transparent p-0 text-inkaer-blue hover:bg-inkaer-light-blue/20"
              >
                <X size={16} className="text-inkaer-blue" />
              </button>
            )}
          </div>
        </motion.div>
