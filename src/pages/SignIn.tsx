  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-white/90 backdrop-blur-sm border-gray-200 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="remember" className="text-sm font-sora text-gray-600">
                    Remember me
                  </Label>
                </div>
                <a href="#" className="text-sm font-sora text-inkaer-blue hover:text-inkaer-dark-blue">
                  Forgot password?
                </a>
              </div>
